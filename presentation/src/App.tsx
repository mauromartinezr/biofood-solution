  ...
  const slides: Slide[] = useMemo(
    () => [
      ...
      },
      {
        id: 'pitch',
        label: 'Pitch',
        title: 'Biofood vende mejor para que las cafeterías aprendan de cada compra.',
        body: (
          <>
            <p className="lead">
              Convertimos consumo, recargas y datos nutricionales en decisiones simples:
              las cafeterías entienden qué compran los estudiantes, las familias recargan
              con contexto y Biofood impulsa qué vender en cada colegio.
            </p>
            <motion.div
              className="journey"
      ...
      },
      {
        id: 'impact',
        label: 'Impacto',
        title: 'Transaccional, recurrente y escala.',
